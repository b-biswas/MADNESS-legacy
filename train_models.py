...
# now train the model
f_net.train_vae(train_generator, validation_generator, callbacks=[checkpointer_vae_loss], epochs=generative_epochs)
...
# now train the model
f_net.train_vae(train_generator, validation_generator, train_decoder = False, callbacks=[checkpointer_deblender_loss], epochs=deblender_epochs)
